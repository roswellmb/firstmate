...
#
# Sourced by bin/fm-spawn.sh, bin/fm-send.sh, bin/fm-control.sh,
# bin/fm-teardown.sh, bin/fm-status-decision-close.sh,
# bin/fm-decision-raise.sh, bin/fm-sessionstart-nudge.sh,
# bin/fm-sessionstart-run.sh, and the tests.
