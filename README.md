...
- **Captain project marks** - [mark a project](docs/configuration.md#captain-project-marks-configproject-marks) off limits or waiting on you, and every dispatch into it is refused rather than merely remembered.
...
- [docs/redaction-guard.md](docs/redaction-guard.md) - install the commit-time guard that keeps private archive document titles out of history, its stated gaps, and its escape hatch.
