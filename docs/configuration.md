...
FM_LOCK_WAIT_TIMEOUT=300   # seconds a blocking lock wait keeps retrying a live holder before giving up with a diagnostic naming the lock and holder; empty, zero, or non-numeric uses 300
